...
2021- & Teacher for pulmonary imaging seminar & Cincinnati Children's Hospital (USA)\\

2020 & Mentor for Biomedical Engineering & University of Cincinnati (USA)\\

 2019 & Mentor intern in Hyperpolarized Gas Lab & Cincinnati Children's Hospital (USA)\\
...
\begin{enumerate}
  ...
  \leftskip-0.13in % for numbers
    \item  Bdaiwi, A., Costa, M., \textbf{Plummer, J.}.,Willmering, M., Cleveland, Z., \& Walkup, L. (2023). B\textsubscript{1} and magnetization decay correction for hyperpolarized \textsuperscript{129}Xe lung imaging using sequential 2D spiral acquisitions. \textit{Magnetic Resonance in Medicine}, Volume: TBC, Issue: TBC. DOI: \href{ https://doi.org/10.1002/mrm.29655}{ 10.1002/mrm.29655}.
