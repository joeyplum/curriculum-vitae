...
\begin{enumerate}
  ...
  \leftskip-0.13in % for numbers
    ...
    \item  \textbf{Plummer, J.}., Hussain, R., Bdaiwi, A., Soderlund, S., Hoyos, X., Lanier, M.J., Garrison, W., Niedbalski, P., Willmering, M., Cleveland, Z., \& Walkup, L. (2024). A decay-modeled compressed sensing reconstruction approach for non-Cartesian hyperpolarized \textsuperscript{129}Xe MRI \textit{Magnetic Resonance in Medicine}, %Volume: TBC, Issue: TBC.
